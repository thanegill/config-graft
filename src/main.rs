...
fn main() {
    ...
    let result = match kind {
        FormatKind::Json => run::<ByteBackend<Json>>(&cli),
        FormatKind::Plist => run::<ByteBackend<Plist>>(&cli),
        FormatKind::Yaml => run::<ByteBackend<Yaml>>(&cli),
        FormatKind::Toml => run::<ByteBackend<Toml>>(&cli),
        FormatKind::Directory => run::<Directory>(&cli),
    };
    match result {
