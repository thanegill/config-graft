...
# specs and assembly are shared (./lib.nix); this file is just the home-manager
# engine.
#
      ...
      optionalAttrs (spec.kind == "plist") {
        cfprefsdDomain = mkOption {
          ...
          description = ''
            ...
            isn't lost to cfprefsd's in-memory cache. A running app keeps its own
            copy of the prefs, so quit it before switching and relaunch afterwards.
