...
unchanged; clean merge and non-merge strategies don't warn)**; **default
array-strategy is `merge`**; **strategy applies only when both are arrays**;
